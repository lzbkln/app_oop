...
public class CellView {
    protected void drawCell(Graphics2D g, Cell cell){
        ...
        fillOval(g, (int)cell.getPositionX(), (int)cell.getPositionY(), cell.getTtl(), cell.getTtl());
        g.setColor(Color.BLACK);
        drawOval(g, (int)cell.getPositionX(), (int)cell.getPositionY(), cell.getTtl(), cell.getTtl());
    }
}